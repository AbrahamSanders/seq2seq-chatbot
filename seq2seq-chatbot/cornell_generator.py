"""
Generator class for the Cornell movie dialog dataset
"""
from os import path

from dataset_generator import DatasetGenerator

class CornellGenerator(DatasetGenerator):
    """Generator implentation for the Cornell movie dialog dataset
    """
    def __init__(self):
        super(CornellGenerator, self).__init__("cornell_movie_dialog")
